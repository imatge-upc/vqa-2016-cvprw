...
class ModelLibrary:
    ...
    def get_model(model_num, vocabulary_size=20000, embed_hidden_size=100, question_max_len=22):
        if model_num == ModelLibrary.MODEL_ONE:
            ...
            return ModelLibrary.get_model_three(vocabulary_size, embed_hidden_size, question_max_len)
    ...
    @staticmethod
    def get_model_three(vocabulary_size=20000, embed_hidden_size=100, question_max_len=22):
